...
len=1160                    % The length of the genomes  
popSize=112;               % The size of the population (must be an even number)
maxGens=250;              % The maximum number of generations allowed in a run
...
if verboseFlag
    ...
    legend('average fitness score','Best fitness score')
end
